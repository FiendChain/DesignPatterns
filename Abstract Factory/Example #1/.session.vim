...
silent only
cd ~\Downloads\Design\ Patterns\Abstract\ Factory
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +3 Shape.cs
badd +1 Abstract\Shape.cs
badd +3 Abstract\Color.cs
badd +0 Abstract\AbstractFactory.cs
badd +1 FactoryA\ShapeFactory.cs
badd +8 FactoryA\ColorFactory.cs
badd +9 FactoryA\Colors.cs
badd +20 FactoryA\Shapes.cs
badd +9 AbstractFactoryDemo.cs
badd +3 FactoryA\FactoryProducer.cs
argglobal
silent! argdel *
edit Abstract\AbstractFactory.cs
...
exe 'vert 2resize ' . ((&columns * 74 + 58) / 117)
exe '3resize ' . ((&lines * 28 + 30) / 60)
exe 'vert 3resize ' . ((&columns * 42 + 58) / 117)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists('Abstract\Color.cs') | buffer Abstract\Color.cs | else | edit Abstract\Color.cs | endif
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-BS> <Plug>delimitMateS-BS
imap <buffer> <BS> <Plug>delimitMateBS
...
wincmd w
argglobal
if bufexists('Abstract\Shape.cs') | buffer Abstract\Shape.cs | else | edit Abstract\Shape.cs | endif
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-BS> <Plug>delimitMateS-BS
imap <buffer> <BS> <Plug>delimitMateBS
...
exe '3resize ' . ((&lines * 28 + 30) / 60)
exe 'vert 3resize ' . ((&columns * 42 + 58) / 117)
tabedit FactoryA\ShapeFactory.cs
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
exe 'vert 1resize ' . ((&columns * 31 + 58) / 117)
exe 'vert 2resize ' . ((&columns * 85 + 58) / 117)
tabedit AbstractFactoryDemo.cs
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
